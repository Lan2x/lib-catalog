                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="role" name="role" required>
                                                    ...
                                                    <option value="3" <?php if($row['role'] == 3) { ?> selected="selected"; <?php } ?>>Encoder1</option>
                                                    <option value="4" <?php if($row['role'] == 4) { ?> selected="selected"; <?php } ?>>Encoder2</option>
                                                    <option value="5" <?php if($row['role'] == 5) { ?> selected="selected"; <?php } ?>>Encoder3</option>
