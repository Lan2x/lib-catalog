          ...
          <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="signage" name="signage" >
                                        ...
                                        ?>
                             <option <?php if($rows['signage']==$row['signage']){ ?>
                                selected="selected"; <?php } ?>><?php echo $rows['signage'];?>
                                  ...
                                  <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="remarks">Call Number <span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="call_number" id="call_number" class="form-control" placeholder="Enter Call Number"  value="<?php echo $row['call_number']; ?>" readonly>
                                       </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="price">Accession number<span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="accession_num" id="accession_num" class="form-control" placeholder="Enter accession number"  value="<?php echo $row['accession_num']; ?>" readonly>
                                       </div>
                                  </div>    
                                  ...
                                  <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="price">Quantity <span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="quantity" id="quantity" class="form-control" placeholder="Enter Quantity" required value="<?php echo $row['quantity']; ?>" readonly>
                                       </div>
                                  </div>                                         
                                  <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="location" name="location">
                                        ...
                                        <?php 
                                         ...
                                         while($rows = mysqli_fetch_array($fetch_signage)){
                                        ?>
                                        <option <?php if($rows['location']==$row['location']){ ?>
